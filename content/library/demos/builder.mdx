---
title: Inception - Vapi Assistant Builder
description: Use Vapi to configure Vapi
date: 2024-03-04
published: true
---
...
<ComponentPreview name="builder-demo" />{" "}

## Code

Copy the following code to your component file for example **_orb.tsx_**. Ensure you have Vapi hook setup.
